...
def profils2(RFIO,IFIO,group,prof1,prof2,prof3,prof4,prof5,prof6):
    pdf: FPDF = FPDF()
    pdf.set_display_mode(zoom='fullwidth')
    pdf.add_page()
    pdf.image("pic.png",195,285, 7,7)
    ...
    if prof5 == 'MS':
        pdf.set_font_size(15)
        pdf.set_xy(35,188)
        pdf.multi_cell(87, 5, 'Методы синтеза и анализа информации в интеллектуальных системах')
        pdf.set_font_size(15)
        pdf.set_xy(136, 190)
        pdf.multi_cell(0, 0, '5')
        pdf.set_xy(168, 190)
    ...
    if prof5 == 'MI':
        pdf.set_font_size(15)
        pdf.set_xy(35,188)
        pdf.multi_cell(87, 5, 'Методы и средства защиты информации')
        pdf.set_font_size(15)
        pdf.set_xy(136, 190)
        pdf.multi_cell(0, 0, '5')
        pdf.set_xy(168, 190)
    ...
    if prof6 == 'MK':
        pdf.set_font_size(15)
        pdf.set_xy(35,188)
        pdf.multi_cell(87, 5, 'Микроконтроллеры и микропроцессоры в системах управления')
        pdf.set_font_size(15)
        pdf.set_xy(136, 190)
        pdf.multi_cell(0, 0, '5')
        pdf.set_xy(168, 190)
        ...
        pdf.set_xy(35, 130)
        pdf.set_font_size(8)
        pdf.output('elect2d05.pdf')
    if prof6 == 'SP':
        pdf.set_font_size(15)
        pdf.set_xy(35,188)
        pdf.multi_cell(87, 5, 'Современная промышленная электроника')
        pdf.set_font_size(15)
        pdf.set_xy(136, 190)
        pdf.multi_cell(0, 0, '5')
        pdf.set_xy(168, 190)
